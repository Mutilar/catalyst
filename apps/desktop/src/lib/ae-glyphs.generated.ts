...
const TOKENS = {
  ...
  'hat.testability': '🧪',
  'hat.tooling': '🔧',
  'identity.android-shell': '📱',
  'identity.butler': '🤖',
  'identity.catalyst': '🚀',
  'identity.envelope': '✉️',
  'identity.genui': '🔮',
  'identity.keystone': '🪨',
  'identity.linux-shell': '🐚',
  'identity.lucid': '🧠',
  'identity.macos-shell': '💻',
  'identity.maintainer-console': '🛠️',
  'identity.marketplace': '🛍️',
  'identity.parakeet': '🦜',
  'identity.penguin': '🐧',
  'identity.plexus': '📡',
  'identity.plexus-service': '🛰️',
  'identity.projects': '🧩',
  'identity.quine': '🧬',
  'identity.repo-maintenance': '🔧',
  'identity.run': '🔥',
  'identity.shell-host': '💻',
  'identity.shells': '🖥️',
  'identity.site': '🌐',
